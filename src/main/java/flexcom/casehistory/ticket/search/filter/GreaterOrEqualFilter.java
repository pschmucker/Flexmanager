...
/**
 * Implementation of a GREATER OR EQUAL filter
 * 
 * @author philippe
 * 
 */
public class GreaterOrEqualFilter implements Filter {
	 ...
	 */
	public GreaterOrEqualFilter(String property, Object value) {
		if (property == null){
